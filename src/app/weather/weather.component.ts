    ...
    this._sharedService.findWeather(this.id_city, this.id_state)
      .subscribe(
        lstresult => {
          ...
          this.op_date = lstresult["query"]["results"]["channel"]["item"]["date"];
          this.op_text = lstresult["query"]["results"]["channel"]["item"]["text"];
          this.op_temp = lstresult["query"]["results"]["channel"]["item"]["temp"];
        },
        error => {
